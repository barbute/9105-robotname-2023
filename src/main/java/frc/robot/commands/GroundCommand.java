...
public class GroundCommand extends CommandBase
{
    ...
    public GroundCommand(ArmSubsystem armSubsystem, double setpoint)
    {
    ...
    {
        pidController.reset();
        System.out.println("Command GROUND has started");
    }
    ...
    public void end(boolean interrupted)
    {
        ...
        System.out.println("Command GROUND has ended");
    }
