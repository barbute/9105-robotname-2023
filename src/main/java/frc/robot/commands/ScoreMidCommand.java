...
public class ScoreMidCommand extends CommandBase
{
    ...
    public ScoreMidCommand(ArmSubsystem armSubsystem, double setpoint)
    {
  ...
  {
    pidController.reset();
    System.out.println("Command SCORE MEDIUM has started");
  }
  ...
  public void end(boolean interrupted) 
  {
    ...
    System.out.println("Command SCORE MEDIUM has stopped");
  }
