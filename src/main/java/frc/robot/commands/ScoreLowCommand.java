...
public class ScoreLowCommand extends CommandBase
{
    ...
    public ScoreLowCommand(ArmSubsystem armSubsystem, double setpoint)
    {
  ...
  {
    pidController.reset();
    System.out.println("Command SCORE LOW has started");
  }
  ...
  public void end(boolean interrupted) 
  {
    ...
    System.out.println("Command SCORE LOW has stopped");
  }
