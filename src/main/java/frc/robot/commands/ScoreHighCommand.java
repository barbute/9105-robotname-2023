...
public class ScoreHighCommand extends CommandBase
{
    ...
    public ScoreHighCommand(ArmSubsystem armSubsystem, double setpoint)
    {
  ...
  {
    pidController.reset();
    System.out.println("Command SCORE HIGH has started");
  }
  ...
  public void end(boolean interrupted) 
  {
    ...
    System.out.println("Command SCORE HIGH has stopped");
  }
